...
const NavLinks = ({ children }: any) => {
  ...
  const activeLink =
    "flex items-start w-full gap-2 px-4 py-2 text-[#C6F4D6] border-l-4 border-bluewhite bg-dashbg";
  const normalLink =
    "flex items-start w-full gap-2 px-4 py-2 text-gray-600 hover:bg-dashbg hover:text-[#C6F4D6] transition-colors duration-300";
        ...
        <div className="">
          <Link to="/" className="flex items-center justify-start ps-4 gap-1">
            ...
            <div>
              ...
              <p className="font-[600] font-[Jost] text-lg leading-4">
                Investment
              </p>
            </div>
          </Link>
          ...
          <nav className="flex flex-col items-start justify-between pt-6">
            ...
            <div
              className="p-6 font-[Jost] flex items-center gap-4 rounded-md cursor-pointer"
