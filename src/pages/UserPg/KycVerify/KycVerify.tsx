...
import { verifyMe } from "../../../assets"
import UserFooter from "../components/UserFooter"


const KycVerify = () => {
  return (
    <div className="bg-[#222736] min-h-screen flex flex-col justify-between" >
      <TopNav />
      <TestScroll />
        <div className="container">
          ...
          <div className="bg-dashcont p-6 text-neutral-100 rounded-lg shadow-md w-full md:w-2/3 mx-auto text-center flex flex-col justify-center items-center">
            <p>Please complete your KYC verification to continue using our services.</p>
            {/* Add form or instructions here */}
            <img src={verifyMe} alt="" className="w-24"/>
            ...
            <button className="bg-green-500 hover:bg-green-600 text-dashcont shadow rounded-lg px-4 py-2">Click here for Verification</button>
            </Link>
